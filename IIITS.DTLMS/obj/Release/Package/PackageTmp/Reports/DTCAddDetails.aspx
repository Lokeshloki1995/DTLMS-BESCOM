        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span8">
                    ...
                    <h3 class="page-title">
                     <a href="#" data-toggle="modal" data-target="#myModal" title="Click For Help" > <i class="fa fa-exclamation-circle" style="font-size: 36px"></i></a>   DTC Added Report
                    </h3>
                ...
                <div class="span12">
                    ...
                    <div class="widget blue">
                        <div class="widget-title">
                            <h4>
                                <i class="icon-reorder"></i>DTC Added Report</h4>
