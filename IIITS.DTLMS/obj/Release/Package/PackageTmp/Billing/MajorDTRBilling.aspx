...
function preventMultipleSubmissions() {
  $('#<%=cmdSave.ClientID %>').prop('disabled', true);
            ...
            if (cmdSavebuttuonstatus.Value == "1")
            {
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                        <asp:HiddenField ID="cmdSavebuttuonstatus" runat="server" />
                                                        ...
                                                        <asp:TextBox ID="txtEstNo" runat="server"  onkeypress="javascript: return onlyAlphabets(event,this);"></asp:TextBox>
