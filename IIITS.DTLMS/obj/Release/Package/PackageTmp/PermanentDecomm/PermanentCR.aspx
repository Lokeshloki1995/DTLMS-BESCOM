        ...
        function ValidateMyForm() {
          ...
          // }
           ...
           if (document.getElementById("<%=txtcertify.ClientID %>").checked != true) {
                ...
                document.getElementById('<%= txtcertify.ClientID %>').focus()
               return false
           }
                    ...
                    <div class="widget-body">
                        <div class="widget-body form">
                            ...
                            <div class="form-horizontal">
                                <div class="row-fluid">
                                    ...
                                    <div class="span5">
                                        <asp:Panel ID="pnlApproval" runat="server">
                                            ...
                                            <%--<div class="control-group">
                                                <label class="control-label">
                                                    Oil capacity(in Litre)STO</label>
                                                <div class="controls">
                                                    <div class="input-append">
                                                        <asp:TextBox ID="txtOilCapacityBySTO" runat="server" MaxLength="10" ReadOnly="true"></asp:TextBox>
                                                        <asp:TextBox ID="TextBox2" runat="server" MaxLength="10" Visible="false" Width="20px"></asp:TextBox>
                                                        <asp:TextBox ID="TextBox3" runat="server" MaxLength="10" Visible="false" Width="20px"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>--%>
                                            <div class="control-group" style="display: none">
                                ...
                                <asp:CheckBox ID="txtcertify"  runat="server"  Checked="true" Enabled="false" /><span class="Mandotary"> *</span>
