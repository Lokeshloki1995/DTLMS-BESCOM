<%@ Page Title="" Language="C#" MasterPageFile="~/DTLMS.Master" AutoEventWireup="true" CodeBehind="DetailedPendingReport.aspx.cs" Inherits="IIITS.DTLMS.Reports.DetailedPendingReport" %>
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span8">
                    ...
                    <h3 class="page-title">Detailed Report
                    </h3>
                                ...
                                <div class="span12">
                                    <div class="text-center" align="center">
                                        ...
                                        <asp:Button ID="Export" runat="server" Text="Generate Report" CssClass="btn btn-primary"
                                            TabIndex="12" OnClick="cmdReport_Click" /><br />
                                        <br />
