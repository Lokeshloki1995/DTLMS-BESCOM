...
{
    public partial class ReplRepaireddetails : System.Web.UI.Page
    {
        string Officecode = string.Empty;
        string strFormCode = "ReplRepaireddetails";
        ...
        protected void Export_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sParam = "id=ReplRepaireddetails&Month=" + month + "&previosyear=" + previousyear + "&presentyear=" + presentyear + "";
