                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="span5">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                        <asp:TextBox ID="txtInvNo" runat="server" TabIndex="1" onkeypress="javascript: return OnlyNumber(event);"></asp:TextBox>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                        <asp:TextBox ID="txtInvdate" runat="server" ReadOnly="true" onkeypress="javascript: return onlyAlphabets(event,this);"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="span5" runat="server" id="dvOld">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                        <asp:TextBox ID="txtInvAmount" runat="server" ReadOnly="true" onkeypress="javascript: return OnlyNumber(event);"></asp:TextBox>
                                                        <br />
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <div class="span5">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-append">
                                                            <asp:TextBox ID="txtRefno" runat="server" TabIndex="2"  MaxLength="20" onkeypress="javascript: return onlyAlphabets(event,this);"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="span5">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-append">
                                                            <asp:TextBox ID="txtBillNo" runat="server" TabIndex="4"  MaxLength="20" onkeypress="javascript: return onlyAlphabets(event,this);"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                        <asp:TextBox ID="txtComment" runat="server" MaxLength="200" TabIndex="12" TextMode="MultiLine"
                                                            Width="550px" Height="125px" Style="resize: none" onkeyup="javascript:ValidateTextlimit(this,200)" onkeypress="javascript: return onlyAlphabets(event,this);"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
