    ...
    public partial class MajorDTRBilling : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    // condtionaly rendering the satric symbul and frezing the reset button 
        ...
        public void GetDatafromMainTable()
        {
            try
            {
                ...
                if (obj.dtEstMatDetails.Rows.Count < 0)
                {
                ...
                if (obj.dtEstLabDetails.Rows.Count < 0)
                {
                ...
                if (obj.dtEstSalDetails.Rows.Count < 0)
                {
        ...
        public void LoadSearchWindow()
        {
            try
            {
                ...
                if (objSession.sRoleType == "2")
                {
                    ...
                    strQry += "and  cast(\"RESTD_NO\" as varchar) not in(SELECT \"WO_DATA_ID\" from \"TBLWORKFLOWOBJECTS\" WHERE \"WO_DATA_ID\"=cast(\"RESTD_NO\" as varchar) and  \"WO_APPROVE_STATUS\"=0 and  \"WO_BO_ID\"=54 )";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ShowMsgBox("Please uplaod the Invoice Copy");
                    fupInvoice.Focus();
                    return;
                }
