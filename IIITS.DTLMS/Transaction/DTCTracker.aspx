                ...
                <asp:GridView ID="grdDTcDetails"  AutoGenerateColumns="false" 
                                ...
                                <Columns>
                                   ...
                                   <asp:TemplateField AccessibleHeaderText="STATUS" HeaderText="Status" SortExpression="STATUS">                                
                                        <ItemTemplate>                                       
                                            <asp:Label ID="lblStatus" runat="server" Text='<%# Bind("STATUS") %>' style="word-break:break-all" Width="250px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                     <asp:TemplateField AccessibleHeaderText="DCT_DTR_CODE" HeaderText="DTR Code" SortExpression="DCT_DTR_CODE">                                
                                        <ItemTemplate>                                       
                                            <asp:Label ID="lblDTrCode" runat="server" Text='<%# Bind("DCT_DTR_CODE") %>' style="word-break:break-all" Width="80px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
