<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RIstatus.ascx.cs" Inherits="IIITS.DTLMS.graphusercontrols.RIstatus" %>

<style>
    /*img#ContentPlaceHolder1_RIstatus_RIstatuschart {
    margin-left: 12%;
}*/
</style>
    ...
    <div style="width:-webkit-fill-available!important"class="span12">
        ...
        <div class="widget blue">
            <div class="widget-title">
                <h4><i class="icon-reorder"></i>RI Status</h4>
                <span class="tools">
            ...
            <asp:Chart ID="RIstatuschart" runat="server" Height="300" Width="900">
                <Titles>
...
<style>
    /*img#ContentPlaceHolder1_RIstatus_RIstatuschart:hover {
