<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RepairerPerformance.ascx.cs" Inherits="IIITS.DTLMS.graphusercontrols.RepairerPerformance" %>


<style>
    div#ContentPlaceHolder1_RepairerPerformance_divdropdwn {
        margin-left:16px;
    }
</style>

        <div class="span6" id="rp">
      
   
        <!-- BEGIN SAMPLE FORMPORTLET-->
        <div class="widget">
            <div class="widget-title">
                <h4><i class="icon-reorder"></i>RepairerPerformance</h4>
            </div>
           ...
           <div id="divdropdwn" class="control-group"  runat="server">
            ...
            <asp:Chart ID="RepairerPerformances" runat="server" Height="300" Width="600">
                <Titles>
                    <asp:Title ShadowOffset="10" Name="Items" />
                </Titles>
                <Series>
                    <asp:Series Name="Pending" />
...
<%--<style>
    img#ContentPlaceHolder1_RepairerPerformance_RepairerPerformances:hover {
